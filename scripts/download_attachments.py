...
def extract_attachments_from_matches(matches: List[Dict[str, Any]], tournament_id: str) -> List[Dict[str, str]]:
    ...
    for match in matches:
        ...
        if attachment_count and attachment_count > 0:
            ...
            try:
                match_attachments = challonge.attachments.index(
                    tournament_id,
                    match_id
                )
                ...
                for attachment in match_attachments:
                    ...
                    if asset_url:
                        ...
                        filename = att_data.get('asset_file_name') or att_data.get('original_file_name')
                        if not filename:
