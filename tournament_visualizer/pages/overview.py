...
from tournament_visualizer.components.layouts import (
    create_page_header, create_metric_grid, create_chart_card,
    create_two_column_layout, create_data_table_card, create_loading_placeholder,
    create_empty_state, create_filter_card
)
from tournament_visualizer.components.charts import (
    create_match_timeline_chart, create_player_performance_chart,
    create_civilization_performance_chart, create_match_duration_distribution,
    create_victory_condition_chart, create_summary_metrics_cards,
    create_empty_chart_placeholder, create_nation_win_percentage_chart,
    create_nation_loss_percentage_chart, create_nation_popularity_chart,
    create_map_breakdown_sunburst_chart, create_map_breakdown_pie_charts,
    create_unit_popularity_sunburst_chart
)
from tournament_visualizer.components.filters import (
    create_date_range_filter, get_filter_values, apply_filters_to_dataframe
)
...
def check_data_status(refresh_clicks: int) -> html.Div:
    ...
    try:
        ...
        return dbc.Alert(
            f"Error checking data status: {str(e)}",
            color="danger",
            dismissable=True
        )